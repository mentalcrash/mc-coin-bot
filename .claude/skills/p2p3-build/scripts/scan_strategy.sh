...
#
# 사용법: bash .claude/skills/p2p3-build/scripts/scan_strategy.sh <strategy_dir>
# 예시:   bash .claude/skills/p2p3-build/scripts/scan_strategy.sh src/strategy/range_squeeze
#
