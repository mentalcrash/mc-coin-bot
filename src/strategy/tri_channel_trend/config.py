"""Triple-Channel Multi-Scale Trend 전략 설정.

3종 채널(Donchian/Keltner/BB) x 3스케일(20/60/150) 앙상블 breakout.
채널 유형별 직교적 측정(극값/ATR정규화/통계편차)의 합의가 단일 채널보다 로버스트.
"""
...
class TriChannelTrendConfig(BaseModel):
    """Triple-Channel Multi-Scale Trend 전략 설정.
    ...
    def _validate_cross_fields(self) -> TriChannelTrendConfig:
