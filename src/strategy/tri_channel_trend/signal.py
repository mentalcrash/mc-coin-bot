"""Triple-Channel Multi-Scale Trend 시그널 생성.

3종 채널(Donchian/Keltner/BB) x 3스케일(20/60/150) breakout consensus 기반 시그널.
...
def generate_signals(df: pd.DataFrame, config: TriChannelTrendConfig) -> StrategySignals:
    """Triple-Channel Multi-Scale Trend 시그널 생성.
    ...
    """
    from src.strategy.tri_channel_trend.config import ShortMode
