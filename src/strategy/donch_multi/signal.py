"""Donchian Multi-Scale 시그널 생성.

3-scale Donchian breakout consensus를 계산하여 방향과 강도를 결정한다.
...
def generate_signals(df: pd.DataFrame, config: DonchMultiConfig) -> StrategySignals:
    """Donchian Multi-Scale 시그널 생성.

    Signal Logic:
        1. 각 lookback(20/40/80)의 Donchian Channel로 breakout 시그널 계산
