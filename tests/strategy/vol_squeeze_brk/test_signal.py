"""Tests for Vol Squeeze Breakout signal generation."""
...
@pytest.fixture
def config() -> VolSqueezeBrkConfig:
    return VolSqueezeBrkConfig()
...
@pytest.fixture
def preprocessed_df(sample_ohlcv_df: pd.DataFrame, config: VolSqueezeBrkConfig) -> pd.DataFrame:
...
class TestSignalStructure:
    ...
    def test_same_length(self, preprocessed_df: pd.DataFrame, config: VolSqueezeBrkConfig) -> None:
        signals = generate_signals(preprocessed_df, config)
