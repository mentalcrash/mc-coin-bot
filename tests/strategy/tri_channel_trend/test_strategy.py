"""Tests for Triple-Channel Multi-Scale Trend strategy integration."""
...
class TestRegistry:
    def test_registered(self) -> None:
        assert "tri-channel-trend" in list_strategies()

    def test_get_strategy(self) -> None:
        cls = get_strategy("tri-channel-trend")
        assert cls is TriChannelTrendStrategy


class TestTriChannelTrendStrategy(_OhlcvMixin):
    def test_name(self) -> None:
        strategy = TriChannelTrendStrategy()
        assert strategy.name == "tri-channel-trend"
    ...
    def test_config(self) -> None:
        strategy = TriChannelTrendStrategy()
        assert isinstance(strategy.config, TriChannelTrendConfig)
    ...
    def test_from_params(self) -> None:
        strategy = TriChannelTrendStrategy.from_params(scale_short=10, scale_mid=40, scale_long=100)
        assert isinstance(strategy, TriChannelTrendStrategy)

    def test_recommended_config(self) -> None:
        config = TriChannelTrendStrategy.recommended_config()
    ...
    def test_custom_config(self) -> None:
        ...
        strategy = TriChannelTrendStrategy(config=config)
    ...
    def test_repr(self) -> None:
        strategy = TriChannelTrendStrategy()
        assert "tri-channel-trend" in strategy.name
