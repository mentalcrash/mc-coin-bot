"""Tests for Vol-of-Vol Momentum signal generation."""
...
class TestVovLogic:
    def test_high_threshold_more_signals(self, sample_ohlcv_df: pd.DataFrame) -> None:
        """Higher vov_threshold = more signals (less filtering)."""
        config_strict = VovMomConfig(vov_threshold=0.1)
        config_loose = VovMomConfig(vov_threshold=0.9)
