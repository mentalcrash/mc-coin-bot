"""Tests for Regime-Adaptive Multi-Lookback Momentum preprocessor."""
...
class TestPreprocess:
    def test_output_columns(
        self, sample_ohlcv_df: pd.DataFrame, config: RegimeAdaptiveMomConfig
    ) -> None:
    ...
    def test_missing_columns(self, config: RegimeAdaptiveMomConfig) -> None:
    ...
    def test_mom_columns_exist(
        self, sample_ohlcv_df: pd.DataFrame, config: RegimeAdaptiveMomConfig
    ) -> None:
        result = preprocess(sample_ohlcv_df, config)
        for col in ["mom_fast", "mom_mid", "mom_slow"]:
