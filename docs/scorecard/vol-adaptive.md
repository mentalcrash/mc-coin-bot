...
G2 IS/OOS    [FAIL] OOS Sharpe 0.02, Decay 98.4%
G3 파라미터  [    ]
G4 심층검증  [    ]
G5 EDA검증   [    ]
G6 모의거래  [    ]
...
**Gate 2** (FAIL): IS Sharpe 1.05, OOS Sharpe 0.02, Decay 98.4%
  - 실패 사유: OOS Sharpe (0.02) < 0.5; Sharpe Decay (98.4%) > 30%
...
| 2026-02-09 | G2 | FAIL | OOS Sharpe 0.02, Decay 98.4% |
