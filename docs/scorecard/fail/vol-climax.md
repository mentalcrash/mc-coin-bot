...
| **상태** | `폐기 (Gate 1 FAIL)` |
| **Best Asset** | SOL/USDT (Sharpe 0.48) |
...
G0 아이디어  [PASS] 22/30점
G0B 코드검증 [PASS]
G1 백테스트  [FAIL] 전 에셋 Sharpe < 1.0, 3/5 음수. BNB MDD -102%, SOL MDD -121%. 즉시 폐기
```
...
| 2026-02-11 | G1 | **FAIL** | 즉시 폐기: BNB MDD 102%, SOL MDD 121% (> 50%). 전 에셋 Sharpe < 1.0, 3/5 음수. Volume climax 시그널 1D 데이터에서 구조적 무효 |
